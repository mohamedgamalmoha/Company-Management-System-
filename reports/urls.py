...
urlpatterns = [
    ...
    path('api/get_all_months_details/<int:user_id>', get_all_months_details, name='get_all_months_details'),
    path('api/get_all_vacations_details/<int:user_id>', get_all_vacations_details, name='get_all_vacations_details'),
